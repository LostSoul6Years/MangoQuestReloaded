...
public class QuestObjectTameMob extends NumerableObject implements EditorObject
{
	...
	public TextComponent toTextComponent(Player p,boolean isFinished) {
		if (hasCustomName())
			...
			return super.toTextComponent(p,ChatColor.stripColor(I18n.locMsg(null,"QuestObject.TameMob")), isFinished, amount, type);
	}

	@Override
	public String toDisplayText() {
		if (hasCustomName())
			return I18n.locMsg(null,"QuestObject.TameMob", Integer.toString(amount), QuestChatManager.translateColor(customName));
		else
			return I18n.locMsg(null,"QuestObject.TameMob", Integer.toString(amount), QuestUtil.translate(type));
	}
