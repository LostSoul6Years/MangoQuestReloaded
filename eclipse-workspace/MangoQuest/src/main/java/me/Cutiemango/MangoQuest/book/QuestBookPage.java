...
public class QuestBookPage {
	...
	/*
	 * CHARACTER_SIZEMAP.put(Character.UnicodeBlock.BASIC_LATIN, new Pair<>(0.95D,
	 * 1.05D)); CHARACTER_SIZEMAP.put(Character.UnicodeBlock.DINGBATS, new
	 * Pair<>(0.7D,0.75D));
	 * CHARACTER_SIZEMAP.put(Character.UnicodeBlock.CJK_SYMBOLS_AND_PUNCTUATION, new
	 * Pair<>(1D, 1.05D));
	 * CHARACTER_SIZEMAP.put(Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS, new
	 * Pair<>(1.10D, 1.15D));
	 * CHARACTER_SIZEMAP.put(Character.UnicodeBlock.HALFWIDTH_AND_FULLWIDTH_FORMS,
	 * new Pair<>(0.7D,0.75D));
	 */
}