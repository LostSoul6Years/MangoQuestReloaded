...
public class QuestObjectKillMob extends NumerableObject implements EditorObject
{
	...
	public TextComponent toTextComponent(Player p,boolean isFinished) {
		if (hasCustomName())
			...
			return super.toTextComponent(p,ChatColor.stripColor(I18n.locMsg(null,"QuestObject.KillMob")), isFinished, amount, type);
	}

	@Override
	public String toDisplayText() {
		if (hasCustomName())
			return I18n.locMsg(null,"QuestObject.KillMob", Integer.toString(amount), QuestChatManager.translateColor(customName));
		else
			return I18n.locMsg(null,"QuestObject.KillMob", Integer.toString(amount), QuestUtil.translate(type));
	}
	@Override
