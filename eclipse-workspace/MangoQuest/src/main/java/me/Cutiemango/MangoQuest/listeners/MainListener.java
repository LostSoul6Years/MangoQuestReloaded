   ...
   /*
	...
	public void onRide(EntityMountEvent e) {
		if(e.getEntity() instanceof Player) {
			...
			if(e.getMount() instanceof LivingEntity && e.getMount() instanceof Tameable) {
				if(pd.getLastTamed()!=null) {
					if(e.getMount() == pd.getLastTamed()) {
						if(((Tameable)e.getMount()).isTamed()&&((Tameable)e.getMount()).getOwner() == p) {
							pd.setLastTamed(null);
							pd.tameMob((LivingEntity) e.getMount());
						}
					}
				}else {
					pd.setLastTamed(e.getMount());
				}
			}
		}
	}
    * */
	...
	public void onInteractEntity(PlayerInteractEntityEvent e) {
		...
		if(e.getPlayer().getInventory().getItemInMainHand()!=null) {
			qd.setLastClicked(e.getPlayer().getInventory().getItemInMainHand().clone());
		}else if(e.getPlayer().getInventory().getItemInOffHand()!=null) {
			qd.setLastClicked(e.getPlayer().getInventory().getItemInOffHand().clone());
		}
	...
	public void onInventoryDrag(InventoryDragEvent e) {
		...
		if(e.getInventory() instanceof AnvilInventory && e.getResult() == Result.) {
			qd.useAnvil(((AnvilInventory)e.getInventory()));
			return;
		}
	}*/
	...
	public void onFish(PlayerFishEvent e) {
		...
		}else if(e.getState().equals(PlayerFishEvent.State.REEL_IN)) {
