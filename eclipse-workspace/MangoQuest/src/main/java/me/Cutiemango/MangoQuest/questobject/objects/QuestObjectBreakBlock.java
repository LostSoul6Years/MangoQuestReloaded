...
public class QuestObjectBreakBlock extends NumerableObject implements EditorObject
{
	...
	public TextComponent toTextComponent(Player p,boolean isFinished) {
		return super.toTextComponent(p,ChatColor.stripColor(I18n.locMsg(null,"QuestObject.BreakBlock")), isFinished, amount, block);
	}

	@Override
	public String toDisplayText() {
		return I18n.locMsg(null,"QuestObject.BreakBlock", Integer.toString(amount), QuestUtil.translate(block), "");
	}
